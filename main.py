...
#watermark_area.block_to_image('F16_block.png')

watermark_area_blocks = divide_block(watermark_area,2 ,2) # 將 watermark_area 浮水印區域 切成3X3 的 block 依序存成 blocks的list
...
watermark = MsaImage('mouse_64.png') 
...
b1_img = MsaImage.reconstruct_image(new_block_list,cols=64,rows=64,w=2,h=2)
